...
const extensionUrl = configuredExtensionUrl || "/messaura-extension-v4.0.0.zip";
...
const benefits = [
  ...
  ["One Messaura account", "Use the same Google account and shared 30-replies-per-day allowance."],
...
function ExtensionPage() {
  ...
  useEffect(() => {
    document.title = "Messaura Chrome Extension | Messaura AI";
  }, []);
  ...
  return (
    <div className="rf-extension-page">
      <header className="rf-extension-nav">
        <a href="/about" className="rf-extension-brand"><span>M</span><strong>Messaura AI</strong></a>
      ...
      <main>
        <section className="rf-extension-hero">
          <div className="rf-extension-copy">
            <span className="rf-extension-eyebrow">Messaura for Chrome</span>
            <h1>Write better replies without leaving your inbox.</h1>
            <p>Bring Messaura directly into Gmail, WhatsApp Web and LinkedIn. Generate, rewrite, improve and insert replies from a focused side panel.</p>
            <div className="rf-extension-actions">
              <a
                href={extensionUrl}
                target={isStoreInstall ? "_blank" : undefined}
                rel={isStoreInstall ? "noreferrer" : undefined}
                download={isStoreInstall ? undefined : "Messaura-Extension-v4.0.0.zip"}
            ...
            {!isStoreInstall && (
              <div className="rf-extension-install-note" role="note">
                ...
                <div className="rf-extension-step-detail" aria-live="polite">
                  {activeInstallStep === 1 && <><span>Click “Download for Chrome” and save the ZIP file.</span><a href={extensionUrl} download="Messaura-Extension-v4.0.0.zip">Download again</a></>}
          ...
          <div className="rf-extension-preview" aria-label="Messaura extension preview">
            <div className="rf-extension-preview-head"><span className="rf-extension-logo">M</span><strong>Messaura AI</strong><em>Connected</em></div>
      ...
      <footer className="rf-extension-footer">Messaura AI · You review every reply before sending.</footer>
    </div>
  );
}
