...
const extensionUrl = configuredExtensionUrl || "/replyforge-extension-v3.3.6.zip";
          ...
          <div className="rf-extension-copy">
            ...
            <div className="rf-extension-actions">
              <a
                ...
                download={isStoreInstall ? undefined : "ReplyForge-Extension-v3.3.6.zip"}
            ...
            {!isStoreInstall && (
              <div className="rf-extension-install-note" role="note">
                ...
                <div className="rf-extension-step-detail" aria-live="polite">
                  {activeInstallStep === 1 && <><span>Click “Download for Chrome” and save the ZIP file.</span><a href={extensionUrl} download="ReplyForge-Extension-v3.3.6.zip">Download again</a></>}
