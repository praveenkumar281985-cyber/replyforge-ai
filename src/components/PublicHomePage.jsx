  ...
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <header className="relative z-10 border-b border-white/10 bg-slate-950/75 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
          <a href="/about" className="flex items-center gap-3" aria-label="ReplyForge AI home">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 text-lg font-black shadow-lg shadow-indigo-950">
              R
            </span>
            <span>
          ...
          <nav className="flex items-center gap-2 sm:gap-3" aria-label="Main navigation">
            ...
            <a
              href="/"
              className="rounded-xl bg-white px-4 py-2.5 text-xs font-black text-slate-950 shadow-lg transition hover:-translate-y-0.5 hover:bg-indigo-50"
            >
              Open ReplyForge
            </a>
          </nav>
      ...
      <main className="relative z-[1]">
        <section className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-[1.08fr_0.92fr] lg:py-24">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">
              ReplyForge AI is an AI reply-writing workspace that helps people
              draft, rewrite, translate, analyze, and organize clear professional
              responses for everyday communication.
            </p>

            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                href="/"
                className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-500 to-violet-600 px-6 py-3.5 text-sm font-black shadow-xl shadow-indigo-950/70 transition hover:-translate-y-0.5"
              >
            ...
            <p className="mt-5 text-xs leading-5 text-slate-500">
              AI-generated replies should always be reviewed before sending.
            </p>
          </div>

          <div className="relative">
            <div className="absolute -inset-8 rounded-full bg-indigo-500/20 blur-3xl" />
            <div className="relative rounded-[28px] border border-white/15 bg-white/[0.07] p-4 shadow-2xl backdrop-blur-xl sm:p-5">
              <div className="rounded-2xl border border-white/10 bg-slate-900/90 p-5 sm:p-6">
                ...
                <div className="mt-4 rounded-2xl bg-gradient-to-r from-indigo-500 to-violet-600 p-4 shadow-lg shadow-indigo-950/60">
