...
const privacySections = [
  {
    ...
    paragraphs: [
      "We collect the information needed to provide Messaura AI, including your name, email address, authentication details, and basic account metadata.",
  ...
  },
  {
    ...
    bullets: [
      "Provide, operate, and maintain Messaura AI.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Messaura also relies on service providers such as Supabase for authentication and data storage, Vercel for application hosting, and Google for optional Google sign-in.",
  ...
  },
  {
    ...
    paragraphs: [
      "We do not sell or rent your personal information. We may share limited information with service providers that help operate Messaura, when required by law, to protect users or the service, or as part of a business reorganization subject to appropriate safeguards.",
    ],
  },
  {
    title: "6. Security",
  ...
  },
  {
    ...
    paragraphs: [
      "Messaura is not intended for children under 13. If local law requires a higher minimum age, a parent or legal guardian must provide any required consent.",
...
const termsSections = [
  {
    ...
    paragraphs: [
      "By accessing or using Messaura AI, you agree to these Terms of Service and our Privacy Policy. If you do not agree, do not use the service.",
  ...
  },
  {
    title: "3. The service",
    paragraphs: [
      "Messaura helps users draft, rewrite, translate, analyze, and organize replies using artificial intelligence. Features, provider availability, usage limits, and free-plan allowances may change as the service develops.",
    ],
  },
  {
    title: "4. Acceptable use",
    bullets: [
      "Do not use Messaura for unlawful, fraudulent, deceptive, abusive, harassing, or harmful activity.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Messaura does not provide legal, medical, financial, employment, or other professional advice. You remain responsible for your communications, decisions, and compliance with applicable laws and workplace policies.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "Messaura depends on third-party services, including authentication, hosting, database, and AI providers. Their services may have separate terms, limits, availability, and privacy practices that we do not control.",
    ],
  },
  {
    title: "8. Availability, suspension, and termination",
    paragraphs: [
      "We may modify, pause, or discontinue features and may suspend or terminate access when reasonably necessary to protect the service, comply with law, address abuse, or enforce these terms. You may stop using Messaura at any time.",
    ],
  },
  {
    title: "9. Disclaimers and limitation of liability",
    paragraphs: [
      "Messaura is provided on an as-is and as-available basis to the extent permitted by law. We do not guarantee uninterrupted service or that AI output will be accurate or fit for a particular purpose.",
      "To the maximum extent permitted by law, Messaura and its operator will not be liable for indirect, incidental, special, consequential, or punitive damages arising from your use of the service. Nothing in these terms excludes liability that cannot legally be excluded.",
    ],
  },
  {
    title: "10. Changes and contact",
    paragraphs: [
      "We may update these terms as Messaura evolves. Continued use after an updated version takes effect means you accept the revised terms, where permitted by law.",
...
function LegalPage({ type }) {
  ...
  useEffect(() => {
    document.title = `${title} | Messaura AI`;
  }, [title]);
    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_#eef2ff_0,_#f8fafc_34%,_#f8fafc_100%)] text-slate-900 lg:h-screen lg:overflow-hidden">
      <header className="sticky top-0 z-10 border-b border-slate-200/80 bg-white/85 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          <a href="/" className="flex items-center gap-3" aria-label="Messaura home">
            ...
            <span>
              <strong className="block text-sm font-black">Messaura AI</strong>
          ...
          <article className="overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-xl shadow-slate-200/50 lg:h-full lg:min-h-0 lg:overflow-y-auto lg:overscroll-contain">
            <div className="border-b border-slate-200 bg-gradient-to-r from-white via-white to-indigo-50/60 px-5 py-5 sm:px-7">
              <p className="max-w-3xl text-sm leading-6 text-slate-600">
                {isPrivacy
                  ? "This policy explains how Messaura AI collects, uses, stores, and shares information when you use the service."
                  : "These terms govern your access to and use of Messaura AI. Please read them carefully before using the service."}
              </p>
            </div>
            ...
            <nav className="flex flex-wrap justify-center gap-x-5 gap-y-2 border-t border-slate-200 bg-slate-50 px-5 py-4 text-xs font-bold text-slate-500">
              ...
              <a href="/" className="hover:text-indigo-700">Messaura AI</a>
            </nav>
          </article>
        </div>
      </main>
